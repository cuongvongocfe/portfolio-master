...
export const siteConfig: SiteConfig = {
  ...
  description: 'Frontend Developer với 5+ năm kinh nghiệm tạo ra những trải nghiệm web hiện đại và tối ưu. Chuyên về React, Next.js, TypeScript.',
