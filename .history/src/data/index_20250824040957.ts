export const timeline = [
  {
    year: '2023 (Aug - Oct)',
    title: 'Marketing Leader – TRAN THANH LONG',
    description: [
      'Thiết kế tài liệu thương hiệu và quảng cáo.',
      'Sáng tạo nội dung marketing và thiết kế hình ảnh.',
      'Chụp ảnh sản phẩm phục vụ quảng bá.'
    ]
  },
  {
    year: '2023 (Nov - nay)',
    title: 'Front-end Developer – Baolongscrap',
    description: [
      'Thực hiện các nhiệm vụ phát triển giao diện web.',
      'Chuyển đổi thiết kế UI/UX thành giao diện responsive.',
      'Phối hợp phát triển các công cụ nội bộ và nền tảng web doanh nghiệp.'
    ]
  },
  {
    year: '2023 (Apr)',
    title: 'Dự án DREAMCAR',
    description: [
      'Xây dựng website giới thiệu xe ô tô với ReactJS.',
      'Cho phép người dùng duyệt, lọc và xem chi tiết các mẫu xe.',
      'Thiết kế UI sạch, tối ưu hiệu năng và trải nghiệm mượt mà.'
    ]
  },
  {
    year: 'Kỹ năng',
    ...
    description: [
      ...
      'Công cụ: Git, GitHub',
      'Thư viện/Framework: React/React-Native, Next.js, Node.js, Bootstrap, Angular, Tailwindcss',
      'Khác: Office, Adobe, Figma',
      'Ngoại ngữ: TOEIC 600'
    ]
  }
];
...
export const siteConfig: SiteConfig = {
  ...
  description: 'Frontend Developer with 2+ years of specialized experience in the React ecosystem. Passionate about building intuitive user interfaces and high-performance applications, always staying up-to-date with the latest technology trends.',
