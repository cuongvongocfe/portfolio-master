            ...
            <div className="flex items-center bg-neutral-50/50 dark:bg-neutral-800/50 backdrop-blur-sm rounded-full px-2 py-1.5 border border-neutral-200/50 dark:border-neutral-700/50">
              {navigationItems.map((item, index) => (
                <motion.button
                  ...
                  className="relative px-4 py-2.5 text-sm font-medium text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-all duration-500 ease-out rounded-full whitespace-nowrap hover:shadow-xl hover:shadow-blue-500/30"
                >
                  <motion.span
                    whileHover={{ 
                      scale: 1.1,
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex items-center gap-2">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                transition={{ type: "spring", stiffness: 400, damping: 17 }}
                className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white text-sm font-medium rounded-full transition-all duration-300 shadow-lg border border-emerald-600/20"
              >
                <span>View CV</span>
                <motion.div
                  initial={{ x: 0 }}
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                transition={{ type: "spring", stiffness: 400, damping: 17 }}
                className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-700 hover:to-violet-700 text-white text-sm font-medium rounded-full transition-all duration-300 shadow-lg border border-blue-600/20"
              >
          ...
          <div className="max-w-7xl mx-auto px-6">
            <nav className="py-6 space-y-1">
              ...
              <motion.div
                ...
                className="pt-4 border-t border-neutral-200/50 dark:border-neutral-700/50 mt-4 space-y-3"
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-medium rounded-lg transition-all duration-300"
                >
                  <span>View CV</span>
                  <span>👁️</span>
                </motion.button>
