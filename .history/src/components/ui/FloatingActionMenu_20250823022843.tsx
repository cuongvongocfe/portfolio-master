        ...
        <AnimatePresence mode="wait">
          {isOpen && menuItems.map((item, index) => (
            ...
            >
              ...
              {/* Tooltip - improved positioning and z-index */}
              <div className="absolute left-full ml-3 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-200 whitespace-nowrap pointer-events-none z-[60] shadow-xl border border-gray-700">
                {item.label}
                {/* Arrow pointer */}
