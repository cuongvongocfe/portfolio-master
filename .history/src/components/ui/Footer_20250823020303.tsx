      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          >
            ...
            >
              <div className="relative w-32 h-32 rounded-lg overflow-hidden bg-neutral-800/50 backdrop-blur-sm border border-neutral-700/50">
                <Image
                  src="/images/meme-ech-xanh-khoi-dong-chuan-bi-dam.gif"
