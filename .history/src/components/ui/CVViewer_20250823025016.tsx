      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-gray-900 w-full max-w-4xl h-full max-h-[90vh] rounded-xl shadow-2xl overflow-hidden flex flex-col"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-primary-50 to-purple-50 dark:from-gray-800 dark:to-gray-700">
              <div className="flex items-center gap-3">
                <FileText className="w-6 h-6 text-primary-600" />
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Curriculum Vitae</h2>
              </div>
                  ...
                  <>
                    ...
                    <button
                      onClick={() => {
                        ...
                        link.href = cvUrl;
                        link.download = 'CV_Nguyen_Van_Cuong.pdf';
                        link.click();
                      }}
