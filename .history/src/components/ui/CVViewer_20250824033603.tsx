    ...
    experience: [
      {
        ...
        responsibilities: [
          "Phát triển và duy trì các ứng dụng web React phục vụ khách hàng nội bộ",
          "Thiết kế giao diện người dùng tối ưu cho nghiệp vụ quản lý phế liệu",
          "Tích hợp API nội bộ và tối ưu hiệu năng hệ thống",
          "Hỗ trợ vận hành và đào tạo nhân viên sử dụng hệ thống mới"
        ]
      },
      {
