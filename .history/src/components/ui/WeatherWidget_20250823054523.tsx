...
export default function WeatherWidget() {
  ...
  return (
    <motion.div
      ...
      className="group flex items-center gap-2 px-3 py-2 rounded-full bg-gradient-to-r from-blue-50/80 to-purple-50/80 dark:from-blue-900/30 dark:to-purple-900/30 backdrop-blur-sm border border-neutral-200/50 dark:border-neutral-700/50"
    >
      {/* Weather Icon */}
      <motion.div
        animate={{ 
