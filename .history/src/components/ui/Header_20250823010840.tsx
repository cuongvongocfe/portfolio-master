        ...
        <div className="flex items-center justify-between h-16 lg:h-18">
          ...
          >
            <div className="relative">
              ...
              >
                {/* GIF Logo - bạn có thể thay đổi src này thành đường dẫn GIF của bạn */}
                <img 
                  src="/images/logo.gif" 
                  alt="Cường Logo" 
                  className="w-full h-full object-cover rounded-lg"
                  onError={(e) => {
                    // Fallback về logo chữ nếu GIF không tải được
                ...
                />
                {/* Fallback logo chữ */}
                <div className="w-full h-full bg-gradient-to-br from-blue-600 via-purple-600 to-violet-700 rounded-lg flex items-center justify-center" style={{ display: 'none' }}>
