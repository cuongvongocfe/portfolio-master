            ...
            <div className="flex items-center bg-neutral-50/50 dark:bg-neutral-800/50 backdrop-blur-sm rounded-full px-2 py-1.5 border border-neutral-200/50 dark:border-neutral-700/50">
              {navigationItems.map((item, index) => (
                <motion.button
                  ...
                  className="relative px-4 py-2.5 text-sm font-medium text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-all duration-300 rounded-full whitespace-nowrap hover:shadow-xl hover:shadow-blue-500/30"
                >
                  <motion.span
                    whileHover={{ 
                      scale: 1.1,
