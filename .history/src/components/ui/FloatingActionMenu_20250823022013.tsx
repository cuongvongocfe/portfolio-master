...
export default function FloatingActionMenu() {
  ...
  return (
    ...
    >
        ...
        {/* Main FAB Button - optimized */}
        <motion.button
          data-fab-button
          onClick={() => !isDragging && setIsOpen(!isOpen)}
          className={`relative w-16 h-16 bg-gradient-to-r from-primary-600 to-purple-600 rounded-full shadow-xl flex items-center justify-center text-white text-2xl transition-shadow duration-200 cursor-move will-change-transform ${
