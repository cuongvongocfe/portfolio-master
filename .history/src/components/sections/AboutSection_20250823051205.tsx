...
export default function AboutSection() {
  ...
  const shortBio = "Frontend Developer with 2+ years of experience specializing in the React ecosystem. I'm passionate about creating intuitive user interfaces and high-performance applications, always staying current with the latest technology trends.";
  
  // Full biography text displayed when expanded
  const fullBio = "Hello! I'm Võ Ngọc Cường, a passionate Frontend Developer with over 2+ years of experience building modern web applications. My expertise focuses on React, Next.js, TypeScript, and cutting-edge frontend technologies.\n\nI believe that good code doesn't just work—it should be readable, maintainable, and scalable. Throughout my career, I've had the opportunity to work on diverse projects, from personal websites to complex web applications, which has helped me develop strong problem-solving skills and effective teamwork abilities.\n\nWhen I'm not coding, I enjoy exploring new technologies, reading about UX/UI design, and sharing knowledge through my personal blog.";
  ...
  const timeline = [
    {
      ...
      description: 'Began my coding journey with HTML, CSS, and JavaScript. Discovered my passion for frontend development.'
    },
    {
      year: '2022',
      title: 'First Projects & React',
      description: 'Built my first portfolio website and started learning React. Created several personal projects to practice.'
    },
    {
      year: '2023',
      title: 'Frontend Developer',
      description: 'Landed my first role as Frontend Developer. Worked with React, Next.js, and modern development tools.'
    },
    {
      year: '2024',
      title: 'Advanced Skills',
      description: 'Expanded expertise in TypeScript, advanced React patterns, and performance optimization techniques.'
    }
  ];
