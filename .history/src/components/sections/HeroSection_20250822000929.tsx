      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-6xl lg:text-7xl font-bold text-neutral-900 dark:text-neutral-100 leading-tight"
          >
            Frontend Developer &{' '}
          ...
          <motion.p
            ...
            className="max-w-3xl mx-auto text-xl text-neutral-600 dark:text-neutral-400 leading-relaxed"
          >
