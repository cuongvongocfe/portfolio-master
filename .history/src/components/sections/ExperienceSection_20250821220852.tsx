    ...
    <section id="experience" className="py-20 lg:py-32 bg-white dark:bg-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Timeline Line */}
          <div className="absolute left-8 md:left-1/2 md:transform md:-translate-x-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary-500 to-purple-500"></div>
          ...
          {experience.map((exp, index) => (
            ...
            >
              {/* Timeline Dot */}
              <div className="absolute left-8 md:left-1/2 md:transform md:-translate-x-1/2 w-4 h-4 bg-primary-500 rounded-full border-4 border-white dark:border-neutral-900 z-10"></div>
              ...
              <div className={`w-full md:w-5/12 ml-20 md:ml-0 ${
                ...
                <motion.div
                  ...
                  className="bg-white dark:bg-neutral-800 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  {/* Company & Role */}
