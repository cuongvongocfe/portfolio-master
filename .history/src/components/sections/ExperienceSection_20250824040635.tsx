...
export default function ExperienceSection() {
  return (
    <section id="experience" className="py-16 sm:py-20 lg:py-32 bg-white dark:bg-neutral-900 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-3xl mx-auto text-xl text-neutral-600 dark:text-neutral-400 leading-relaxed">
            Dòng thời gian về sự phát triển nghề nghiệp của tôi và những đội ngũ tuyệt vời mà tôi có vinh dự được làm việc cùng
          </p>
        </motion.div>
...
// Removed local export of 'experience' to resolve naming conflict
export const localExperience = experience; // Renamed variable
