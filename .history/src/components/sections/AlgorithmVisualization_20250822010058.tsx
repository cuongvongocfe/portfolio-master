    ...
    <section id="algorithm-visualization" className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8 overflow-hidden"
        >
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6 gap-3 sm:gap-4">
            <div className="flex flex-wrap gap-2 sm:gap-4">
              <button
                ...
                disabled={isRunning}
                className="px-4 sm:px-6 py-2 bg-gradient-to-r from-purple-500 to-cyan-500 text-white rounded-lg font-medium hover:opacity-90 transition-opacity disabled:opacity-50 text-sm sm:text-base"
              >
                Generate Array
              </button>
              <button
