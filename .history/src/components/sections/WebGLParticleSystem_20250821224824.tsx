...
export default function WebGLParticleSystem() {
  ...
  useEffect(() => {
    ...
    const updateNeuralPattern = (particle: Particle) => {
    ...
    const updateSpiralPattern = (particle: Particle, index: number) => {
      ...
      particle.hue = (270 + angle * 57.3 + index * 10) % 360;
    };
    ...
    const updateFractalPattern = (particle: Particle) => {
      const time = Date.now() * 0.001;
