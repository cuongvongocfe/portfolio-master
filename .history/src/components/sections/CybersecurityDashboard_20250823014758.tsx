...
interface SecurityThreat {
  ...
  severity: 'low' | 'medium' | 'high' | 'crit            <div className="space-y-4">
              {securityTools.map((tool) => (
                <div key={tool.name} className="flex items-center justify-between p-4 bg-gray-900/50 rounded-lg border border-gray-700">{l';
  source: string;
  target: string;
  timestamp: string;
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-400">Loading security systems...</p>
          </div>
        </div>
      </section>
    );
