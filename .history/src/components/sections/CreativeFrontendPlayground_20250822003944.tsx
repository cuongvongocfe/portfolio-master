...
{text.split('').map((char, index) => (
  ...
  return (
    <section id="frontend-playground" className="py-20 bg-gradient-to-br from-black via-gray-900 to-black text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex gap-4 bg-gray-900/50 rounded-lg p-2 border border-gray-700">
