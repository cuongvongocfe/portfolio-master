      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <motion.p
            ...
            className="text-lg font-medium text-primary-600 dark:text-primary-400 drop-shadow-sm bg-white/40 dark:bg-black/40 backdrop-blur-sm rounded-full px-6 py-2 inline-block border border-white/30 dark:border-gray-700/30"
          >
            Hi, I&apos;m Cường 👋
          </motion.p>
