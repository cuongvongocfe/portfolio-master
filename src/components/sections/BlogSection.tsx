  ...
  return (
    <section id="blog" className="py-20 lg:py-32 bg-neutral-50 dark:bg-neutral-900/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post, index) => (
            <motion.article
              ...
              className="group"
            >
              {/* Blog Post Card with Hover Animation */}
              <motion.div
                whileHover={{ y: -5 }}
              ...
              >
                {/* Hero Image Section with Tag Overlay */}
                ...
                <div className="p-6">
                  ...
                  {/* Post Title with Hover Color Change */}
        ...
        {/* Call-to-Action Button for All Posts */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          {/* View All Posts Button with Hover Effects */}
          <motion.a
            href="/blog"
