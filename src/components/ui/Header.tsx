...
export default function Header() {
  ...
  // Luôn bật dark mode khi load trang
  useEffect(() => {
   ...
   * 
   * Switches between dark and light mode, updating state and document classes.
   */
  const toggleTheme = () => {
    setIsDark(!isDark);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16 lg:h-18">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Weather Widget: only show on sm+ screens */}
            <div className="hidden sm:block">
              <WeatherWidget />
            </div>

            {/* CV View Button: only show on sm+ screens */}
            <motion.button
            ...
            >
              <div className="w-4 h-0.5 bg-neutral-600 dark:bg-neutral-400 rounded-full mt-1" />
            </motion.button>
          </div>
        </div>
